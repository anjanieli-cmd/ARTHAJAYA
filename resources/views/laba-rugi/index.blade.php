<x-app-layout>
    ...
    <style>
        ...
        /* ROW dengan actions selalu terlihat */
        .lr-row{
        ...
        /* Actions selalu terlihat, tidak perlu hover */
        .lr-row-actions{
        ...
        .lra-btn.view{ color:var(--info); border-color:rgba(var(--info-rgb),0.3); }
        .lra-btn.view:hover{ background:rgba(var(--info-rgb),0.1); border-color:var(--info); }
        .lra-btn.edit{ color:var(--emerald); border-color:rgba(var(--emerald-rgb),0.3); }
        .lra-btn.edit:hover{ background:rgba(var(--emerald-rgb),0.1); border-color:var(--emerald); }
        .lra-btn.del{ color:var(--danger); border-color:rgba(var(--danger-rgb),0.3); }
        .lra-btn.del:hover{ background:rgba(var(--danger-rgb),0.1); border-color:var(--danger); }
        ...
        /* Fix untuk icon agar selalu terlihat */
        .icon {
