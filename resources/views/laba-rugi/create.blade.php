    ...
    <div class="pl-modern">
        ...
        <div class="pl-header animate-in" style="animation-delay: 0.05s;">
            <div class="pl-header-left">
                ...
                <p class="subtitle">
                    Catat pos <strong>pendapatan</strong> atau <strong>beban</strong> untuk periode tertentu.
                    Pos ini akan muncul di laporan Laba Rugi.
                </p>
            </div>
        ...
        <!-- ===== FORM ===== -->
        <form method="POST" action="{{ route('laba-rugi.store') }}" class="animate-in" style="animation-delay: 0.10s;" id="labaRugiForm">
            @csrf
            ...
            <div class="pl-panel">
                ...
                <div class="pl-panel-icon">
                    ...
                    <div class="info">
                        <div class="label">Informasi Pos Laba Rugi</div>
                        <div class="desc">
                            Isi data pos <strong>pendapatan</strong> atau <strong>beban</strong> dengan benar.
                            Pastikan periode bulan dan tahun sesuai.
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-form-grid">
                    ...
                    <div class="pl-field">
                        ...
                        <select name="period_month" id="period_month" required>
                            ...
                            @for($m = 1; $m <= 12; $m++)
                                <option value="{{ $m }}" {{ old('period_month') == $m ? 'selected' : '' }}>
                    ...
                    <div class="pl-field">
                        ...
                        <select name="period_year" id="period_year" required>
                            ...
                            @for($y = date('Y') - 5; $y <= date('Y') + 1; $y++)
                                <option value="{{ $y }}" {{ old('period_year') == $y ? 'selected' : '' }}>
                                    {{ $y }}
                                </option>
                            @endfor
                        </select>
                ...
                <div class="pl-actions">
                    <div class="left">
                        ...
                        <span>Semua data akan tersimpan di laporan Laba Rugi</span>
                    </div>
                    <div class="right">
                        <a href="{{ route('laba-rugi.index') }}" class="pl-btn pl-btn-outline">
