<x-app-layout>
    ...
    <style>
        ...
        .pay-card-footer .btn-action.pay {
            color: var(--success);
            border-color: var(--success-soft);
        }

        .pay-card-footer .btn-action.pay:hover {
            background: var(--success-soft);
        ...
        <div class="pay-grid" id="payrollGrid">
            @forelse($payrolls as $index => $p)
                @php
                    ...
                    $period = $p['period'] ?? '';
                @endphp
                <div class="pay-card {{ $statusClass }} animate-in payroll-item" 
                    ...
                    <div class="pay-card-footer">
                        ...
                        <div class="actions">
                            @if($p['status'] == 'pending')
                                <a href="/payroll/pay/{{ $itemId }}" class="btn-action pay" title="Bayar">
                                    <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            @endif
                            <a href="/payroll/show/{{ $itemId }}" class="btn-action show" title="Lihat Detail">
                                <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <a href="/payroll/edit/{{ $itemId }}" class="btn-action edit" title="Edit">
                                <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
