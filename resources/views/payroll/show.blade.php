<x-app-layout>
    ...
    @php
        ...
        // $payroll sudah dikirim langsung dari route, tinggal pakai
        $payroll = array_merge([
            'id' => $index ?? 0,
            'employee' => 'Karyawan Tidak Diketahui',
        ...
        $payroll['total'] = $payroll['basic_salary'] + $payroll['allowance'] - $payroll['deduction'];
    ...
    <div class="pd-wrap">
        ...
        <div class="pd-header animate-in" style="animation-delay: 0.05s;">
            <div class="pd-header-left">
                ...
                <p class="subtitle">
                    Slip gaji — <strong>{{ $payroll['employee'] }}</strong> — {{ $payroll['period'] }}
                </p>
            </div>
            <div class="pd-actions">
                ...
                <a href="{{ route('payroll.edit', ['index' => $payroll['id']]) }}" class="pd-btn pd-btn-primary">
        ...
        <div class="pd-content">
            ...
            <div class="pd-card animate-in" style="animation-delay: 0.10s;">
                ...
                <div class="pd-info-group">
                    ...
                    <div class="value">{{ $payroll['employee'] }}</div>
                </div>
                ...
                <div class="pd-info-row">
                    ...
                    <div class="pd-info-group">
                        ...
                        <div class="value">
                            <span class="badge {{ $statusBadge[$payroll['status']] ?? 'pending' }}">
                                {{ $statusIcon[$payroll['status']] ?? '⏳' }} {{ $statusLabel[$payroll['status']] ?? 'Pending' }}
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="pd-sidebar">
                <div class="pd-card animate-in" style="animation-delay: 0.15s;">
                    ...
                    <div class="pd-summary-item">
                        <span class="label">Karyawan</span>
                        <span class="value">{{ $payroll['employee'] }}</span>
                    </div>
                    <div class="pd-summary-item">
                        <span class="label">Jabatan</span>
                        <span class="value">{{ $payroll['position'] }}</span>
                    </div>
                    <div class="pd-summary-item">
                        <span class="label">Periode</span>
                    ...
                    <div class="pd-summary-item">
                        <span class="label">Status</span>
                        <span class="value">
                            <span class="badge {{ $statusBadge[$payroll['status']] ?? 'pending' }}" style="display:inline-block;padding:2px 10px;border-radius:100px;font-size:11px;">
                                {{ $statusIcon[$payroll['status']] ?? '⏳' }} {{ $statusLabel[$payroll['status']] ?? 'Pending' }}
                            </span>
                        </span>
                    </div>
