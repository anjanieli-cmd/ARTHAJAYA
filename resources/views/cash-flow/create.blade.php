...
<div class="page-head">
    ...
    <p>Catat pergerakan kas masuk atau keluar sesuai aktivitas.</p>
</div>
...
<form method="POST" action="{{ route('cash-flow.store') }}">
    ...
    <div class="panel">
        <div class="panel-icon-row">
            <div class="panel-icon"><svg class="icon"><use href="#ic-receive"/></svg></div>
            <span>Kelompokkan transaksi ke aktivitas Operasional, Investasi, atau Pendanaan.</span>
        </div>
