<x-app-layout>
    ...
    <svg style="display:none;" xmlns="http://www.w3.org/2000/svg">
        <defs>
            ...
            <symbol id="ic-search" viewBox="0 0 24 24" fill="none"
            ...
            <symbol id="ic-x" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
            ...
            <symbol id="ic-edit" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
            ...
            <symbol id="ic-alert-triangle" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
            ...
            <symbol id="ic-check-circle" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
            ...
            <symbol id="ic-plus" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
            ...
            <symbol id="ic-file-text" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
            ...
            <symbol id="ic-trending" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
            ...
            <symbol id="ic-clock" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
            ...
            <symbol id="ic-chevron-right" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="exp-modern">
        ...
        @if(session('success'))
            <div class="exp-success animate-in"
        ...
        <div class="exp-stats" id="expStatCards">
            ...
            <div class="exp-stat-card animate-in"
                ...
                <div class="stat-value primary mono"
                     id="expTotalAmount">

                    {{ $currencySymbol }}{{ formatAngkaPendek($totalPengeluaran) }}

                </div>

                <div class="stat-sub" id="expTotalSub">
                    {{ $countLunas + $countPending }} transaksi total
                </div>
            ...
            <div class="exp-stat-card animate-in"
                ...
                <div class="stat-value success mono"
                     id="expPaidAmount">

                    {{ $currencySymbol }}{{ formatAngkaPendek($totalLunas) }}

                </div>

                <div class="stat-sub" id="expPaidSub">

                    {{ $totalPengeluaran > 0
                        ? round(($totalLunas / $totalPengeluaran) * 100)
                        : 0
                    }}% dari total
            ...
            <div class="exp-stat-card animate-in"
                ...
                <div class="stat-value warning mono"
                     id="expPendingAmount">

                    {{ $currencySymbol }}{{ formatAngkaPendek($totalPending) }}

                </div>

                <div class="stat-sub" id="expPendingSub">

                    {{ $totalPengeluaran > 0
                        ? round(($totalPending / $totalPengeluaran) * 100)
                        : 0
                    }}% dari total
                        ...
                        @forelse($expenses as $index => $e)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="exp-status {{ $statusPill[$currentStatus] ?? 'pending' }}">
                                ...
                                <td class="exp-amount mono">
                                    ...
                                    {{ $currencySymbol }}{{ formatAngkaPendek($e->amount ?? 0) }}
                            ...
                            <tr>
                                ...
                                <td colspan="6">
                                    ...
                                    <div class="exp-empty">
                                        ...
                                        <p>
                                            Belum ada pengeluaran yang tercatat di sistem.
                                        </p>
    ...
    <script>
        ...
        function openDeleteModal(id, description) {
            ...
            const descriptionElement =
                document.getElementById('deleteExpenseDesc');

            const deleteForm =
                document.getElementById('deleteForm');

            if (!modal || !descriptionElement || !deleteForm) {
                return;
            }
            ...
            /*
             * PENTING:
             * Sekarang menggunakan ID database asli,
             * bukan index dari foreach.
             */
            deleteForm.action =
                '/expenses/delete/' + id;
        ...
        document.addEventListener(
            ...
            function () {
                ...
                function updateResults(
                    ...
                    if (!expTableWrap) return;

                    expTableWrap.classList.add(
                        'loading'
                    );
