...
@endphp
    ...
    <style>
        ...
        .expense-create-wrap .animate-in {
            animation:
                fadeSlideUp 0.6s cubic-bezier(0.16, 1, 0.3, 1)
                forwards;

            opacity: 0;
        }

        .expense-create-wrap .icon {
            width: 18px;
            height: 18px;
            flex-shrink: 0;
        ...
        .ec-btn .ripple {
            ...
            animation:
                rippleAnim 0.6s ease-out forwards;
    ...
    <div class="expense-create-wrap">

        {{-- HEADER --}}
        <div
            class="ec-header animate-in"
        ...
        >
            <div class="ec-header-left">
                ...
                <p class="subtitle">
                    Isi data pengeluaran dengan lengkap
                </p>
        ...
        @if(session('success'))
            <div
                class="ec-alert success animate-in"
        ...
        @if($errors->any())
            <div
                class="ec-alert error animate-in"
            ...
            >
                    ...
                    <div class="ec-group">
                        ...
                        >
                            ...
                            @forelse($categories as $category)
                                ...
                                <option
                                    value="{{ $category->id }}"
                                    {{ (string) old('expense_category_id') === (string) $category->id ? 'selected' : '' }}
                                >
                                    {{ $category->name }}
                                </option>
                ...
                <div class="ec-group">
                    ...
                    >
                        ...
                        <option
                            value="lunas"
                            {{ old('status', 'lunas') === 'lunas' ? 'selected' : '' }}
                        >
                            Lunas
                        </option>
