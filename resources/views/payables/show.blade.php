<x-app-layout>
    ...
    @php
        ...
        $statusColor = [
            'lancar' => 'var(--theme-primary)',
            'jatuh_tempo' => 'var(--danger)',
            'lunas' => 'var(--text-tertiary)'
        ];
        $statusBg = [
            'lancar' => 'var(--theme-soft)',
            'jatuh_tempo' => 'var(--danger-soft)',
            'lunas' => 'var(--bg-card-active)'
        ];
    @endphp
    ...
    <style>
        ...
        .dt-item .value .status-pill.lancar {
            background: var(--theme-soft);
            color: var(--theme-primary);
        }

        .dt-item .value .status-pill.jatuh_tempo {
    ...
    <div class="detail-wrap">
        ...
        <div class="dt-header animate-in" style="animation-delay: 0.05s;">
            <div class="dt-header-left">
                ...
                <p class="subtitle">Informasi lengkap tagihan dari vendor</p>
            </div>
            <div class="dt-actions">
                <a href="/payables" class="dt-btn dt-btn-ghost">
                ...
                <a href="/payables/{{ $index }}/edit" class="dt-btn dt-btn-primary">
                    <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="dt-card animate-in" style="animation-delay: 0.10s;">
            ...
            <div class="dt-card-header">
                ...
                <div class="title-group">
                    ...
                    <div class="sub">Detail lengkap tagihan dari vendor</div>
                </div>
            </div>
            ...
            <div class="dt-grid">
                <div class="dt-item">
                    ...
                    <div class="value">{{ $payable['vendor'] }}</div>
                </div>
                <div class="dt-item">
                    <div class="label">Nomor Tagihan</div>
                    <div class="value mono">{{ $payable['bill'] }}</div>
                </div>
                <div class="dt-item">
                    <div class="label">Tanggal</div>
                    <div class="value">{{ \Carbon\Carbon::parse($payable['date'])->translatedFormat('d M Y') }}</div>
                </div>
                <div class="dt-item">
                    <div class="label">Jatuh Tempo</div>
                    <div class="value">{{ \Carbon\Carbon::parse($payable['due'])->translatedFormat('d M Y') }}</div>
                </div>
                <div class="dt-item">
                    <div class="label">Status</div>
                    <div class="value">
                        <span class="status-pill {{ $payable['status'] }}">
                ...
                <div class="dt-item">
                    ...
                    <div class="value mono primary" style="font-size: 24px;">
                        {{ $currencySymbol }}{{ number_format($payable['amount'], 0, ',', '.') }}
                    </div>
                </div>
            </div>
