<x-app-layout>
    <x-slot name="title">Edit Penawaran {{ $quote->quote_number }}</x-slot>
    ...
    <style>
        ...
        .quote-edit-wrap *{ box-sizing:border-box; }

        @keyframes fadeSlideUp{ from{ opacity:0; transform:translateY(20px);} to{ opacity:1; transform:translateY(0);} }
        .quote-edit-wrap .animate-in{ animation:fadeSlideUp .5s cubic-bezier(.16,1,.3,1) forwards; opacity:0; }
        ...
        .st-expired .sdot{ background:var(--warning); }
    ...
    <div class="quote-edit-wrap">
        ...
        <div class="page-head animate-in" style="animation-delay:.05s;">
            <div class="page-head-left">
                ...
                <p>
                    Perbarui data penawaran untuk 
                    <strong>{{ $quote->client->name ?? 'klien terhapus' }}</strong>
            ...
            <div class="head-actions">
                <a href="{{ route('quotes.show', $quote) }}" class="btn btn-outline btn-sm">
        ...
        {{-- ===== FORM ===== --}}
        <form method="POST" action="{{ route('quotes.update', $quote) }}" class="animate-in" style="animation-delay:.10s;">
            @csrf
            @method('PUT')
            ...
            <div class="form-panel">
                ...
                <div class="form-panel-header">
                    ...
                    <div>
                        <h2>Edit Informasi Penawaran</h2>
                        <p>Perbarui data penawaran #{{ $quote->quote_number }}</p>
                    </div>
                ...
                <div class="form-body">
                    ...
                    <div class="info-box">
                        ...
                        <div style="font-size:12px; color:var(--text-muted);">
                            <svg class="icon" style="width:14px;height:14px;display:inline;vertical-align:middle;"><use href="#ic-info"/></svg>
                    ...
                    <div class="field-grid">
                        ...
                        <div class="field-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="date" name="issue_date" class="has-icon" value="{{ old('issue_date', $quote->issue_date?->format('Y-m-d')) }}" required>
                            </div>
                            @error('issue_date')
                                <div class="field-error">
                                    <span>⚠️</span> {{ $message }}
                        ...
                        <div class="field-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="date" name="valid_until" class="has-icon" value="{{ old('valid_until', $quote->valid_until?->format('Y-m-d')) }}" required>
                            </div>
                            @error('valid_until')
                                <div class="field-error">
                                    <span>⚠️</span> {{ $message }}
                    ...
                    <div class="field-grid">
                        ...
                        <div class="field-group">
                            ...
                            @enderror
                            <div class="field-hint">Status penawaran saat ini.</div>
                        </div>
                        ...
                        <div class="field-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="number" name="subtotal" class="has-icon" value="{{ old('subtotal', $quote->subtotal) }}" step="0.01" min="0" required>
                            </div>
                            @error('subtotal')
                                <div class="field-error">
                                    <span>⚠️</span> {{ $message }}
                        ...
                        <div class="field-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="number" name="tax_amount" class="has-icon" value="{{ old('tax_amount', $quote->tax_amount) }}" step="0.01" min="0">
                            </div>
                            @error('tax_amount')
                                <div class="field-error">
                                    <span>⚠️</span> {{ $message }}
                    ...
                    <div class="field-grid" style="margin-top:8px;">
                        <div class="field-group full">
                            ...
                            <textarea name="notes" rows="4" placeholder="Tambahkan catatan atau deskripsi untuk penawaran ini...">{{ old('notes', $quote->notes) }}</textarea>
                            @error('notes')
                                <div class="field-error">
                                    <span>⚠️</span> {{ $message }}
                                </div>
