<x-app-layout>
    <x-slot name="title">Buat Faktur</x-slot>
    ...
    <style>
        ...
        .inv-create-wrap *{ box-sizing:border-box; }

        @keyframes fadeSlideUp{ from{ opacity:0; transform:translateY(20px);} to{ opacity:1; transform:translateY(0);} }
        .inv-create-wrap .animate-in{ animation:fadeSlideUp .5s cubic-bezier(.16,1,.3,1) forwards; opacity:0; }
    ...
    <div class="inv-create-wrap">
        ...
        <div class="page-head animate-in" style="animation-delay:.05s;">
            <div class="page-head-left">
                <h1>Buat Faktur Baru</h1>
                <p>Isi detail faktur untuk klienmu. Nomor faktur akan dibuat otomatis oleh sistem.</p>
            </div>
        ...
        {{-- ===== FORM ===== --}}
        <form method="POST" action="{{ route('invoices.store') }}" class="animate-in" style="animation-delay:.10s;">
            @csrf
            ...
            <div class="form-panel">
                ...
                <div class="form-panel-header">
                    ...
                    <div>
                        <h2>Detail Faktur</h2>
                        <p>Lengkapi semua informasi yang diperlukan untuk membuat faktur penjualan.</p>
                    </div>
                </div>
                ...
                <div class="form-body">
                    ...
                    <div class="field-grid">
                        ...
                        <div class="field-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" class="has-icon" value="{{ $nextInvoiceNumber ?? 'INV-'.date('Ymd').'-001' }}" disabled style="opacity:0.7; cursor:not-allowed;">
                            </div>
                            <div class="field-hint">Nomor faktur akan dibuat otomatis oleh sistem.</div>
                        </div>
                        ...
                        <div class="field-group">
                            ...
                            @enderror
                            <div class="field-hint">Status awal faktur saat dibuat.</div>
                        </div>
                    </div>
                    ...
                    <div class="field-grid" style="margin-top:8px;">
                        <div class="field-group full">
                            ...
                            <textarea name="description" rows="4" placeholder="Tambahkan catatan atau deskripsi untuk faktur ini...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="field-error">
                                    <span>⚠️</span> {{ $message }}
                                </div>
