...
<style>
    ...
    .panel{ background:var(--surface); border:1px solid var(--border); border-radius:20px; padding:36px 40px; }
...
<div class="page-head">
    ...
    <p>Isi detail faktur untuk klienmu. Nomor faktur akan dibuat otomatis.</p>
</div>
