    ...
    <div class="emp-edit-wrap">
        ...
        <div class="emp-edit-header animate-in" style="animation-delay: 0.05s;">
            <div class="emp-edit-header-left">
                ...
                <h1>Edit Karyawan</h1>
                <p class="subtitle">
                    Perbarui data karyawan — <strong>{{ $employee['name'] ?? 'Nama Tidak Diketahui' }}</strong>
                </p>
            </div>
        ...
        <!-- ===== FORM - FULL WIDTH ===== -->
        <form method="POST" action="{{ route('employees.update', ['index' => $index ?? 0]) }}" class="emp-edit-form" id="employeeForm">
            @csrf
            @method('PUT')
            ...
            <div class="emp-edit-card animate-in" style="animation-delay: 0.10s;">
                ...
                <div class="emp-form-group">
                    ...
                    <input type="text" name="name" value="{{ $employee['name'] ?? '' }}" placeholder="Masukkan nama lengkap" required>
                </div>
                ...
                <div class="emp-form-row">
                    <div class="emp-form-group">
                        ...
                        <input type="text" name="position" value="{{ $employee['position'] ?? '' }}" placeholder="Contoh: Pengrajin Batik" required>
                    </div>
                    <div class="emp-form-group">
                        <label>Departemen <span class="required">*</span></label>
                        <input type="text" name="department" value="{{ $employee['department'] ?? '' }}" placeholder="Contoh: Produksi" required>
                    </div>
                </div>
                ...
                <div class="emp-form-row">
                    <div class="emp-form-group">
                        ...
                        <input type="email" name="email" value="{{ $employee['email'] ?? '' }}" placeholder="email@perusahaan.com" required>
                    </div>
                    <div class="emp-form-group">
                        <label>Telepon <span class="required">*</span></label>
                        <input type="text" name="phone" value="{{ $employee['phone'] ?? '' }}" placeholder="Contoh: 0812-3456-7890" required>
                    </div>
                </div>
                ...
                <div class="emp-form-row">
                    <div class="emp-form-group">
                        ...
                        <input type="number" name="salary" value="{{ $employee['salary'] ?? '' }}" placeholder="0" min="0" step="1000" required>
                    </div>
                    <div class="emp-form-group">
                        <label>Tanggal Bergabung <span class="required">*</span></label>
                        <input type="date" name="joined" value="{{ isset($employee['joined']) ? formatTanggal($employee['joined']) : '' }}" required>
                    </div>
                </div>
                ...
                <div class="emp-form-group">
                    ...
                    <select name="status" required>
                        @foreach($statusOptions as $key => $label)
                            <option value="{{ $key }}" {{ (isset($employee['status']) && $employee['status'] == $key) ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
