<x-app-layout>
    ...
    <style>
        ...
        .pm-option:has(input:checked) {
            ...
            box-shadow: 0 0 0 1px rgba({{ $accentRgb }}, .1);
        }
        ...
        .btn-pay:hover {
            ...
            box-shadow: 0 8px 32px rgba({{ $accentRgb }}, .35);
        }
    ...
    <div class="checkout-wrap">
        ...
        <form
            method="POST"
            action="{{ route('payment.process', ['plan' => $planKey]) }}"
            id="paymentForm"
        >
            @csrf
            ...
            <div class="checkout-grid">
                ...
                <div class="checkout-card">
                    ...
                    <p class="sub">
                        ...
                        Detail pembayaran akan diisi melalui halaman resmi Midtrans.
                    </p>
                    ...
                    <label class="pm-option">
                        ...
                        <span class="pm-info">
                            ...
                            <span class="pm-desc">
                                BCA, Mandiri, BNI, BRI — via Virtual Account
                            </span>
                        </span>
                    ...
                    <label class="pm-option">
                        ...
                        <span class="pm-info">
                            ...
                            <span class="pm-desc">
                                Scan QR code dengan mobile banking atau e-wallet
                            </span>
                        </span>
                    ...
                    <div class="checkout-note">
                        ...
                        <span>
                            Setelah klik "Bayar Sekarang", sistem akan
                            memproses transaksi dan mengarahkan kamu ke
                            halaman pembayaran resmi Midtrans.
                        </span>
