<x-app-layout>
    ...
    <svg style="display:none;">
        <defs>
            ...
            <symbol id="ic-user-plus" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <style>
        ...
        .client-create-wrap *{ box-sizing:border-box; }

        @keyframes fadeSlideUp{ from{ opacity:0; transform:translateY(20px);} to{ opacity:1; transform:translateY(0);} }
        .client-create-wrap .animate-in{ animation:fadeSlideUp .5s cubic-bezier(.16,1,.3,1) forwards; opacity:0; }
    ...
    <div class="client-create-wrap">
        ...
        <div class="page-head animate-in" style="animation-delay:.05s;">
            <div class="page-head-left">
                ...
                <p>Masukkan data klien untuk mulai membuat faktur dan penawaran.</p>
            </div>
        ...
        {{-- ===== FORM ===== --}}
        <form method="POST" action="{{ route('clients.store') }}" class="animate-in" style="animation-delay:.10s;">
            @csrf
            ...
            <div class="form-panel">
                ...
                <div class="form-panel-header">
                    <div class="icon-wrap">
                        <svg class="icon"><use href="#ic-user-plus"/></svg>
                    </div>
                    <div>
                        <h2>Informasi Klien</h2>
                        <p>Lengkapi data klien untuk keperluan faktur dan penawaran.</p>
                    </div>
                </div>
                ...
                <div class="form-body">
                    ...
                    <div class="field-grid">
                        ...
                        <div class="field-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" name="name" class="has-icon" value="{{ old('name') }}" placeholder="Masukkan nama klien..." required>
                            </div>
                            @error('name')
                        ...
                        <div class="field-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" name="company_name" class="has-icon" value="{{ old('company_name') }}" placeholder="Masukkan nama perusahaan...">
                            </div>
                            @error('company_name')
                                <div class="field-error">
                                    <span>⚠️</span> {{ $message }}
                    ...
                    <div class="field-grid">
                        ...
                        <div class="field-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="email" name="email" class="has-icon" value="{{ old('email') }}" placeholder="Masukkan alamat email...">
                            </div>
                            @error('email')
                                <div class="field-error">
                                    <span>⚠️</span> {{ $message }}
                        ...
                        <div class="field-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" name="phone" class="has-icon" value="{{ old('phone') }}" placeholder="Masukkan nomor telepon...">
                            </div>
                            @error('phone')
                                <div class="field-error">
                                    <span>⚠️</span> {{ $message }}
                    ...
                    <div class="field-grid" style="margin-top:8px;">
                        <div class="field-group full">
                            ...
                            <div class="input-wrap" style="position:relative;">
                                ...
                                <textarea name="address" style="padding-left:42px;" placeholder="Masukkan alamat lengkap klien...">{{ old('address') }}</textarea>
                            </div>
                            @error('address')
                                <div class="field-error">
                                    <span>⚠️</span> {{ $message }}
                    ...
                    <div class="field-grid" style="margin-top:8px;">
                        <div class="field-group full">
                            ...
                            <textarea name="notes" placeholder="Tambahkan catatan tambahan tentang klien...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="field-error">
                                    <span>⚠️</span> {{ $message }}
                                </div>
