...
<style>
  ...
  /* PREVIEW CARD — bagian yang paling membedakan tampilan ini dari fitur lain */
  .preview-card{
...
<div class="inv-page-head">
  ...
  <p>Daftarkan barang ke inventaris. Nilai stok dan margin akan terhitung otomatis di panel sebelah kanan.</p>
</div>
  ...
  <div class="inv-panel">
    <form method="POST" action="{{ route('inventory.store') }}" id="invForm">
      ...
      <div class="inv-actions">
        <button type="submit" class="inv-btn inv-btn-primary">Simpan Barang</button>
