<x-app-layout>
    ...
    <svg style="display:none;">
        <defs>
            ...
            <symbol id="ic-box-plus" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/><line x1="12" y1="15" x2="12" y2="9"/><line x1="9" y1="12" x2="15" y2="12"/>
            </symbol>
    ...
    <style>
        ...
        .item-create-wrap *{ box-sizing:border-box; }

        @keyframes fadeSlideUp{ from{ opacity:0; transform:translateY(20px);} to{ opacity:1; transform:translateY(0);} }
        .item-create-wrap .animate-in{ animation:fadeSlideUp .5s cubic-bezier(.16,1,.3,1) forwards; opacity:0; }
    ...
    <div class="item-create-wrap">
        ...
        <div class="page-head animate-in" style="animation-delay:.05s;">
            <div class="page-head-left">
                ...
                <p>Daftarkan barang ke inventaris untuk mulai melacak stok.</p>
            </div>
        ...
        <div class="form-layout animate-in" style="animation-delay:.10s;">
            ...
            <div class="form-panel">
                ...
                <div class="form-panel-header">
                    <div class="icon-wrap">
                        <svg class="icon"><use href="#ic-box-plus"/></svg>
                    </div>
                    <div>
                        <h2>Informasi Barang</h2>
                        <p>Lengkapi data barang untuk inventaris.</p>
                    </div>
                </div>

                {{-- Form Body --}}
                <div class="form-body">
                    <form method="POST" action="{{ route('inventory.store') }}" id="invForm">
                        @csrf
                        ...
                        <div class="field-grid">
                            <div class="field-group">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <input type="text" name="name" class="has-icon" value="{{ old('name') }}" placeholder="Masukkan nama barang..." required>
                                </div>
                                @error('name')
                            ...
                            <div class="field-group">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <input type="text" name="sku" class="has-icon" value="{{ old('sku') }}" placeholder="Masukkan SKU..." required>
                                </div>
                                @error('sku')
                                    <div class="field-error">
                                        <span>⚠️</span> {{ $message }}
                        ...
                        <div class="field-grid">
                            <div class="field-group">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <input type="number" name="stock_quantity" id="stockInput" class="has-icon" value="{{ old('stock_quantity', 0) }}" step="1" min="0" required>
                                </div>
                                ...
                                @enderror
                                <div class="field-hint">Jumlah stok awal barang.</div>
                            </div>
                            ...
                            <div class="field-group">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <input type="number" name="reorder_level" class="has-icon" value="{{ old('reorder_level', 0) }}" step="1" min="0">
                                </div>
                                @error('reorder_level')
                                    <div class="field-error">
                                        <span>⚠️</span> {{ $message }}
                        ...
                        <div class="field-grid">
                            <div class="field-group">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <input type="number" name="cost_price" id="costInput" class="has-icon" value="{{ old('cost_price', 0) }}" step="0.01" min="0" required>
                                </div>
                                @error('cost_price')
                                    <div class="field-error">
                                        <span>⚠️</span> {{ $message }}
                            ...
                            <div class="field-group">
                                ...
                                <div class="input-wrap">
                                    <svg class="icon"><use href="#ic-dollar"/></svg>
                                    <input type="number" name="selling_price" id="sellInput" class="has-icon" value="{{ old('selling_price', 0) }}" step="0.01" min="0" required>
                                </div>
                                @error('selling_price')
                                    <div class="field-error">
                                        <span>⚠️</span> {{ $message }}
                        ...
                        <div class="field-grid">
                            <div class="field-group">
                                ...
                                <div class="input-wrap">
                                    <svg class="icon"><use href="#ic-tag"/></svg>
                                    <input type="text" name="category" class="has-icon" value="{{ old('category') }}" placeholder="Masukkan kategori...">
                                </div>
                                @error('category')
                                    <div class="field-error">
                                        <span>⚠️</span> {{ $message }}
                            ...
                            <div class="field-group">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <input type="text" name="unit" class="has-icon" value="{{ old('unit', 'pcs') }}" placeholder="Masukkan satuan..." required>
                                </div>
                                @error('unit')
                                    <div class="field-error">
                                        <span>⚠️</span> {{ $message }}
                        ...
                        <div class="field-grid" style="margin-top:8px;">
                            <div class="field-group full">
                                ...
                                <textarea name="description" placeholder="Tambahkan deskripsi atau catatan untuk barang ini...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="field-error">
                                        <span>⚠️</span> {{ $message }}
                                    </div>
            ...
            <div class="preview-card">
                ...
                <div class="preview-stat">
                    <div class="k">Total Nilai Stok Awal</div>
